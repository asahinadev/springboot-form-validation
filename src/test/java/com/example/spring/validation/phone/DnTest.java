...
@SpringBootTest
public class DnTest
		extends SpringParameterized<DnTest.Form, PhoneType> {
	...
	public static List<ParameterBase<PhoneType>> data() {
		...
		list.add(new ParameterBase<>(
				PhoneType.builder().tel1("1").tel2("1234").tel3("1234").build(), 1));
		list.add(new ParameterBase<>(
				PhoneType.builder().tel1("123456").tel2("1234").tel3("1234").build(), 1));
		list.add(new ParameterBase<>(
				PhoneType.builder().tel1("12").tel2("12345").tel3("1234").build(), 1));
		list.add(new ParameterBase<>(
				PhoneType.builder().tel1("12").tel2("1234").tel3("123").build(), 1));
		list.add(new ParameterBase<>(
				PhoneType.builder().tel1("12").tel2("1234").tel3("12345").build(), 1));

		list.add(new ParameterBase<>(
				PhoneType.builder().tel1("123").tel2("123").tel3("1234").build(), 1));

		list.add(new ParameterBase<>(
				PhoneType.builder().tel1("01").tel2("1234").tel3("1234").build(), 0));
		list.add(new ParameterBase<>(
				PhoneType.builder().tel1("012").tel2("123").tel3("1234").build(), 0));
		list.add(new ParameterBase<>(
				PhoneType.builder().tel1("0123").tel2("12").tel3("1234").build(), 0));
		list.add(new ParameterBase<>(
				PhoneType.builder().tel1("01234").tel2("1").tel3("1234").build(), 0));

		return list;
	}

	public DnTest(ParameterBase<PhoneType> parameter) {
