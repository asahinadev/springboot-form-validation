...
@SpringBootTest
public class IpPhoneTest
		extends SpringParameterized<IpPhoneTest.Form, PhoneType> {
	...
	public static List<ParameterBase<PhoneType>> data() {
		...
		list.add(new ParameterBase<>(
				PhoneType.builder().tel1("050").tel2("1234").tel3("1234").build(), 0));
		list.add(new ParameterBase<>(
	...
	public IpPhoneTest(ParameterBase<PhoneType> parameter) {
