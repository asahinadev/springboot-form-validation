...
@SpringBootTest
public class FromToByByteTest2
		extends BasedFromToTest2<Byte> {
	...
	public static List<ParameterBase<FromToType<Byte>>> data() {
		...
		list.add(new ParameterBase<>(FromToType.<Byte>builder().from(c1).to(c1).build(), 1));
	...
	public FromToByByteTest2(ParameterBase<FromToType<Byte>> parameter) {
