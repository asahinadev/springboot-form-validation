...
@SpringBootTest
public class FromToByBigIntegerTest
		extends BasedFromToTest<BigInteger> {
	...
	public static List<ParameterBase<FromToType<BigInteger>>> data() {
		...
		list.add(new ParameterBase<>(FromToType.<BigInteger>builder().from(c1).to(c1).build(), 0));
	...
	public FromToByBigIntegerTest(ParameterBase<FromToType<BigInteger>> parameter) {
