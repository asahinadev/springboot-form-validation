...
@SpringBootTest
public class FromToByFloatTest2
		extends BasedFromToTest2<Float> {
	...
	public static List<ParameterBase<FromToType<Float>>> data() {
		...
		list.add(new ParameterBase<>(FromToType.<Float>builder().from(c1).to(c1).build(), 1));
	...
	public FromToByFloatTest2(ParameterBase<FromToType<Float>> parameter) {
