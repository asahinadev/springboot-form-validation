...
@SpringBootTest
public class FromToByDoubleTest
		extends BasedFromToTest<Double> {
	...
	public static List<ParameterBase<FromToType<Double>>> data() {
		...
		list.add(new ParameterBase<>(FromToType.<Double>builder().from(c1).to(c1).build(), 0));
	...
	public FromToByDoubleTest(ParameterBase<FromToType<Double>> parameter) {
