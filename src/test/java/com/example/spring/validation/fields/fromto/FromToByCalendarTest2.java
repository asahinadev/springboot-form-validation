...
@SpringBootTest
public class FromToByCalendarTest2
		extends BasedFromToTest2<Calendar> {
	...
	public static List<ParameterBase<FromToType<Calendar>>> data() {
		...
		list.add(new ParameterBase<>(FromToType.<Calendar>builder().from(c1).to(c1).build(), 1));
	...
	public FromToByCalendarTest2(ParameterBase<FromToType<Calendar>> parameter) {
