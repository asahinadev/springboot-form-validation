...
@SpringBootTest
public class FromToByBigDecimalTest2
		extends BasedFromToTest<BigDecimal> {
	...
	public static List<ParameterBase<FromToType<BigDecimal>>> data() {
		...
		list.add(new ParameterBase<>(FromToType.<BigDecimal>builder().from(c1).to(c1).build(), 0));
	...
	public FromToByBigDecimalTest2(ParameterBase<FromToType<BigDecimal>> parameter) {
