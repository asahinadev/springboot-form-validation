...
@SpringBootTest
public class FromToByShortTest
		extends BasedFromToTest<Short> {
	...
	public static List<ParameterBase<FromToType<Short>>> data() {
		...
		list.add(new ParameterBase<>(FromToType.<Short>builder().from(c1).to(c1).build(), 0));
	...
	public FromToByShortTest(ParameterBase<FromToType<Short>> parameter) {
